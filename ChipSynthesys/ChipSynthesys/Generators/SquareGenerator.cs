            ...
            out PlacementGlobal placement)
        {
            ...
            for (int k = 0; k < nets; k++)
            {
                ...
                for (int j = 0; j < components; j++)
                {
                    ...
                    if ((x_q == x_j + w_j && y_q == y_j) || (x_q == x_j && y_q == y_j + h_j)
                        || (x_q + w_q == x_j && y_q == y_j) || (x_q == x_j && y_q + h_q == y_j))
                    {
                        Net.Add(j);
                        i++;
                    }
                    if ((x_j + w_j == x_q && y_j < y_q && y_q < y_j + h_j)
                        || (x_j + w_j == x_q && y_q < y_j && y_j < y_q + h_q)
                        || (x_q + w_q == x_j && y_j < y_q && y_q < y_j + h_j)
                        || (x_q + w_q == x_j && y_q < y_j && y_j < y_q + h_q))
                    {
                        Net.Add(j);
                        i++;
                    }
                    if ((y_j + h_j == y_q && x_j < x_q && x_q < w_j + x_j)
                        || (y_j + h_j == y_q && x_q < x_j && x_j < x_q + w_q)
                        || (y_q + h_q == y_j && x_j < x_q && x_q < w_j + x_j)
                        || (y_q + h_q == y_j && x_q < x_j && x_j < x_q + w_q))
                    {
                        Net.Add(j);
                        i++;
                    }
