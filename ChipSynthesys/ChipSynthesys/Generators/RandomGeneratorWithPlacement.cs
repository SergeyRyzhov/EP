...
{
    public class RandomGeneratorWithPlacement : IGenerator
    {
            ...
            out Design design, out PlacementDetail placement)
        {
            ...
            this.NextDesignWithPlacement(components, nets, maxNetSize, percent, maxSizeX, maxSizeY, sizeX, sizeY, out design,
                out placement);
        }
            ...
            int maxSizeX, int maxSizeY, int sizeX, int sizeY, out Design design, out PlacementDetail placement)
        {
            ...
            do
            {
                ...
                this.Split(xCoord, yCoord, idx, ref compCount);
