...
namespace ChipSynthesys.UnitTests.Draw
{
    ...
    public class DrawerTests
    {
        ...
        public void PlacerTest()
        {
            ...
            Size size;
            Bitmap bitmap;
            GenerateTestBigDesign(out design, out placement, out size, out bitmap);
        ...
        private void GenerateTestDesign(out Design design, out PlacementDetail placement, out Size size, out Bitmap bitmap)
        {
            ...
            const double mx = (0 + maxx) / 2.0; //мат.ожидание
            const double my = (0 + maxy) / 2.0;
        ...
        private void GenerateTestBigDesign(out Design design, out PlacementDetail placement, out Size size, out Bitmap bitmap)
        {
            IGenerator generator = new RandomGenerator();
            ...
            const double volume = n * mx * my * (100.0 / p);
            int side = Convert.ToInt32(Math.Ceiling(Math.Sqrt(volume)) * 0.7);
